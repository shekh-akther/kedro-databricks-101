...
# kedro_databricks_101 documentation build
...
from kedro_databricks_101 import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_databricks_101"
author = "Kedro"
...
htmlhelp_basename = "kedro_databricks_101doc"
...
latex_documents = [
    (
        master_doc,
        "kedro_databricks_101.tex",
        "kedro_databricks_101 Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_databricks_101",
        "Project kedro_databricks_101 codebase.",
        "Nearest-Neighbour",
    )
]
